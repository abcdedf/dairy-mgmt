// lib/pages/madhusudan_pnl_page.dart

import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:intl/intl.dart';
import '../controllers/madhusudan_pnl_controller.dart';
import '../core/csv_export.dart';
import 'shared_widgets.dart';

class MadhusudanPnlPage extends StatefulWidget {
  const MadhusudanPnlPage({super.key});
  @override
  State<MadhusudanPnlPage> createState() => _MadhusudanPnlPageState();
}

class _MadhusudanPnlPageState extends State<MadhusudanPnlPage> {
  late final MadhusudanPnlController ctrl;
  ...
  void _exportCsv(MadhusudanPnlController c) {
    if (c.rows.isEmpty) return;
    const headers = ['Date', 'Milk KG', 'Sale Rate', 'Revenue', 'Cost', 'Profit'];
    final csvRows = c.rows.map((r) => [
      r.entryDate, '${r.totalFfMilkKg}',
      r.saleRate.toStringAsFixed(2),
      r.revenue.toStringAsFixed(2),
      r.cost.toStringAsFixed(2),
      r.profit.toStringAsFixed(2),
    ]).toList();
    exportCsv(fileName: 'madhusudan_pnl.csv', headers: headers, rows: csvRows);
  }
        ...
        Expanded(child: Obx(() {
          ...
          if (ctrl.rows.isEmpty) {
            return const EmptyState(
              ...
              message: 'No Madhusudan sales recorded yet.',
            );
          }
...
class _ReportBody extends StatelessWidget {
  final MadhusudanPnlController ctrl;
    ...
    return Column(children: [
      ...
      Container(
        ...
        child: const Row(children: [
          ...
          Expanded(flex: 2, child: Text('Milk KG',
        ...
        itemBuilder: (_, i) {
          ...
          return Container(
            ...
            child: Row(children: [
              ...
              Expanded(flex: 2, child: Text(
                '₹${row.saleRate.toStringAsFixed(2)}',
                textAlign: TextAlign.center,
                style: const TextStyle(fontSize: 12),
              )),
              Expanded(flex: 2, child: Text(
      ...
      Obx(() {
        ...
        return Container(
          ...
          child: Row(children: [
            ...
            Expanded(flex: 2, child: Text('${t.totalFfMilkKg} KG',
                textAlign: TextAlign.center,
